...
//	public static BigInteger DATATYPE_BIG_INTEGER = new BigInteger( "0" );
     ...
     * @param klass  The target class to which the datatype should be converted
     * @return
     */
     ...
     * @return
     */
    public static String convertValueToStringDatatype(Object aValue) {
        if (aValue == null) {
            return null;
     ...
     * @return
     */
    public static BigDecimal convertValueToBigDecimalDatatype(Object aValue) {
        if (aValue == null) {
            return null;
     ...
     * @return
     */
    public static BigInteger convertValueToBigIntegerDatatype(Object aValue) {
        if (aValue == null) {
            return null;
        } else if (aValue instanceof BigInteger) {
